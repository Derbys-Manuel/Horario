                ...
                <table class="table  text-center align-middle">
                    ...
                    <tbody>
                        <tr id="h17">
                            ...
                            <td id="lu17" rowspan="2"></td>
                            <td id="ma17" rowspan="2"></td>
                            <td id="mi17" rowspan="2"></td>
                            <td id="ju17" rowspan="2"></td>
                            <td id="vi17" rowspan="2"></td>
                            <td id="sa17" rowspan="2"></td>
                            <td id="do17" rowspan="2"></td>
                        </tr>
                        <tr id="h18">
                        ...
                        <tr id="h20">
                            ...
                            <td id="lu20" rowspan="2"></td>
                            <td id="ma20" rowspan="2"></td>
                            <td id="mi20" rowspan="2"></td>
                            <td id="ju20" rowspan="2"></td>
                            <td id="vi20" rowspan="2"></td>
                            <td id="sa20" rowspan="2"></td>
                            <td id="do20" rowspan="2"></td>
                        </tr>
                        <tr id="h12">
