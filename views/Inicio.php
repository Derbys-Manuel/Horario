...
<body>
    ...
    <div class="container"> 
        <div class="row justify-content-center position-relative">
            <div class="col col-4">
                <div class="toolbar position-absolute bottom-0 start-0 mb-2 ms-4">
                    <div class="menu">
                    ...
                    <div id="toolbarContent" class="toolbar-content">
                        ...
                        <!-- Botón Horario -->
                        <div class="btn-icon btn_horarios btn_horario2" id="btnHorario">
            ...
            <div class="col col-8">
                <div class="ms-4">
                    <img src="../assets/img/mascota.png" alt="Imagen de la academia Elite" width="200px">
                </div>
            </div>
        </div>
