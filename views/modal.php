                ...
                <div class="modal-header horario-header">
                    <table class="table table-borderless">
                        <thead class="position-relative">
                            ...
                            <th scope="col">
                                <div class="d-flex">
                                    <h1 class="modal-title fs-5  h text-light mt-2" id="staticBackdropLabel2">HORARIO: <span id="nombre-horario-pm"></span></h1>
                                    <button class="btn menu" id="btnAgregar1"><i class="bi bi-plus-circle-fill text-success "></i></button>
                                </div>
                            </th>
                            <th scope="col" >
                                <div class=" d-flex position-absolute top-0 end-0 mx-3 mt-3">
                                        <h1 class="modal-title fs-5 h1Bloques  mx-3 menu text-light " id="staticBackdropLabel1">SELECCIÓN <span class="d-none"id="cantidadBloques"></span></h1>
                                    <div class="btn-icon2 mx-2  menu" id="btnCancel6" style="display:none;">
                                        <i class="bi bi-x-circle"></i>
                                        <span class="tooltiptext">Cancelar</span>
                                    </div>
                                </div>
                            ...
                            <th scope="col">
                                <div class="d-flex align-items-center mt-2">
                                    <button class="btn-001 btn btn-success menu ">Editar</button>
                                    <div class="btn-icon2 mx-3 menu" id="btnCancel2" style="display:none;">
                                        <i class="bi bi-x-circle"></i>
                                        <span class="tooltiptext">Cancelar</span>
                                    </div>
                                </div>
