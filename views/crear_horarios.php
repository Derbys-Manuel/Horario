...
<body>
    <div class="container-fluid text-center">
        <img src="../assets/img/asasas2-removebg.png" width="150px">
        ...
        <div>
            ...
            <button id="btnCrearHorario" class="btn btn-success">Crear Horario</button>
        </div>
    ...
    function cargarHorarios() {
        $.get('../php/horario/listar_horarios.php', function(response) {
            ...
            calculo = horarios.length
            let html = '';
            if (calculo===0)
            {
                html = `<tr>
                            <td colspan="2">No hay horarios</td>
                        </tr>`;
