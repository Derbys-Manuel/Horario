...
<head>
    ...
    <title>Horarios Elite</title>
    <link rel="icon" href="assets/img/icons8-calendario-blue-96.png" style="width: 96px;">
    <link rel="stylesheet" href="assets/index.css?v=<?php echo $date['seconds'] ?>">
