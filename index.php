    ...
    <div class="container">
        ...
        <div class="botones-container">
            <div class="boton-wrapper" id="crear-horarios-wrapper">
                <a href="./views/crear_horarios.php" class="button" id="crear-horarios-btn">Crear Horarios</a>
            </div>
            <div class="boton-wrapper" id="ver-profesores-wrapper">
                <a href="./views/Inicio.php" class="button" id="registros-btn">Registros</a>
            </div>
            <div class="boton-wrapper" id="ver-wrapper">
                <a href="./views/horarios.php" class="button" id="ver-btn">Ver Horarios</a>
            </div>
        </div>
    </div>
</body>
