...
$query = 'INSERT INTO registro (disponibilidad_i,disponibilidad_f,dia,id_p,tiempo,direccion,turno, valor, id_h) VALUES (:disponibilidad_i,:disponibilidad_f,:dia,:id_p,:tiempo,:direccion,:turno, :valor, :id_h)';
